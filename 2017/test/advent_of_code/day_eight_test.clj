(ns advent-of-code.day-eight-test
  (:require [advent-of-code.day-eight :as de]
...
(deftest part-one
  (testing
    (is (= 1 (de/largest-value program1)))
    (is (= 3089 (de/largest-value input)))))

(deftest part-two
  (testing
    (is (= 10 (de/largest-value-ever-seen program1)))
    (is (= 5391 (de/largest-value-ever-seen input)))))
